                ...
                >
                    ...
                    >
                        <div className="flex items-center justify-between px-5 py-4 border-b border-[rgba(55,53,47,0.08)]">
                            ...
                            <button onClick={() => setIsCopyModalOpen(false)} className="text-[rgba(55,53,47,0.3)] border-none bg-transparent cursor-pointer">
                        ...
                        <div className="p-5 pt-0">
                            ...
                            >
                                {statsCopied ? (
                                    ...
                                    <>
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="2" width="6" height="4" rx="1"/><path d="M8 4H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-2"/></svg>
                                        クリップボードにコピー
                                    </>
                                )}
                            </button>
