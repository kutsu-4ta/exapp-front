            ...
            <div style={content}>
                ...
                {viewMode === 'list' ? (
                    <div style={listContainer}>
                        ...
                        {listLogs.length > 0 ? listLogs.map((log) => {
                ...
                <div style={modalOverlay} onClick={() => setIsModalOpen(false)}>
                    <div style={modalContent} onClick={(e) => e.stopPropagation()}>
                        ...
                        <div style={modalActions}>
                            <button onClick={() => setIsModalOpen(false)} style={cancelBtn}>キャンセル</button>
                            <button onClick={handleConfirm} style={confirmBtn}>OK</button>
                        </div>
                    </div>
                </div>
            )}
