...
import { cardBase, cardLabel, cardSub } from './StatCard'
...
export function MonthlyGoalCard({
    ...
    return (
        <div style={cardBase}>
            <span style={cardLabel}>MONTHLY GOAL</span>
            {!isEditing ? (
                <div style={goalDisplay} onClick={onEditStart}>
                    <p style={valueStyle}>
                        {targetMin}h <span style={rangeSep}>〜</span> {targetMax}h
                    </p>
            ...
            <p style={cardSub}>Target Range</p>
        </div>
    )
}
...
const editGroup: React.CSSProperties = {
    display: 'flex',
    alignItems: 'center',
    gap: '4px',
    height: '32px',
