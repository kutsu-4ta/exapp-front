...
export const container: React.CSSProperties = {
    maxWidth: '600px', margin: '0 auto', padding: '0 16px', color: c.text,
}

export const stickyHeader: React.CSSProperties = {
    position: 'sticky', top: 0, zIndex: 1000,
    backgroundColor: 'rgba(255,255,255,0.98)', backdropFilter: 'blur(8px)',
    borderBottom: `1px solid ${c.border}`, margin: '0 -16px 20px', padding: '12px 20px',
}
...
export const yearTxt: React.CSSProperties = {
    fontSize: font.xs, color: c.textSub, fontWeight: 700,
}

export const statsBadge: React.CSSProperties = {
    display: 'flex', gap: '10px', backgroundColor: c.surface,
...
export const yearInput: React.CSSProperties = {
    ...
    border: `1px solid ${c.border}`, fontSize: '13px', textAlign: 'center',
}
...
export const finishBtn: React.CSSProperties = {
    flex: 2, padding: '16px', backgroundColor: c.blue, color: '#fff',
    border: 'none', borderRadius: '12px', fontSize: font.base, fontWeight: 800, cursor: 'pointer',
}

export const saveBtn: React.CSSProperties = {
    flex: 2, padding: '16px', backgroundColor: c.text, color: '#fff',
    border: 'none', borderRadius: '12px', fontSize: font.base, fontWeight: 800, cursor: 'pointer',
}

export const examBackBtn: React.CSSProperties = {
    flex: 1, padding: '16px', backgroundColor: '#fff', color: c.text,
