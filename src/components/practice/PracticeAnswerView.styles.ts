...
export const parentHeader: React.CSSProperties = {
    fontSize: font.md, fontWeight: 800, color: c.text,
}
...
export const addSubBtn: React.CSSProperties = {
    padding: '6px 10px', fontSize: font.sm, borderRadius: '6px',
...
export const sideControl: React.CSSProperties = {
    ...
    flexDirection: 'column', gap: '4px', paddingTop: '10px',
}
...
export const subLabel: React.CSSProperties = {
    fontSize: font.sm, fontWeight: 700, color: c.textSub,
}
...
export const memoTextarea: React.CSSProperties = {
    ...
    fontSize: font.sm, resize: 'vertical', boxSizing: 'border-box', background: '#fff',
}
...
export const descriptiveTextarea: React.CSSProperties = {
    flex: 1, minHeight: '80px', padding: '10px', borderRadius: '6px',
...
export const okBtn: React.CSSProperties = {
    ...
    fontWeight: 700, cursor: 'pointer', fontSize: font.base,
}
...
export const myAnswerText: React.CSSProperties = {
    flex: 1, fontSize: font.base, fontWeight: 500,
...
export const memoReviewBlock: React.CSSProperties = {
    ...
    background: 'rgba(55,53,47,0.03)', border: `1px solid rgba(55,53,47,0.06)`,
}
...
export const memoReviewLabel: React.CSSProperties = {
    fontSize: font.xs, fontWeight: 800, color: c.textSub,
    minWidth: '14px', marginTop: '1px',
}

export const memoReviewText: React.CSSProperties = {
    fontSize: font.sm, color: c.textSub, lineHeight: 1.5, whiteSpace: 'pre-wrap',
}
...
export const rankLabel: React.CSSProperties = {
    fontSize: font.xs, fontWeight: 700, color: c.textHint, marginLeft: '8px',
}
...
export const addProblemBtn: React.CSSProperties = {
    ...
    border: `1px solid ${c.border}`, background: '#fff',
    color: c.text, fontWeight: 600, fontSize: font.sm, cursor: 'pointer',
}
