...
const cardHeader: React.CSSProperties = { padding: '14px 16px 16px', borderBottom: `1px solid ${c.border}`, flexShrink: 0 }
...
const body: React.CSSProperties = { padding: '20px 16px', overflowY: 'auto', flex: 1, display: 'flex', flexDirection: 'column', gap: '20px', paddingBottom: 'calc(20px + env(safe-area-inset-bottom, 0px))' }
...
const confirmBtn: React.CSSProperties = { width: '100%', padding: '14px', borderRadius: '10px', border: 'none', fontSize: '16px', fontWeight: 700, cursor: 'pointer', transition: 'opacity 0.15s', marginTop: 'auto' }
