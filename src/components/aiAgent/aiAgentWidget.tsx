...
export function AIAgentWidget({ onGetAdvice }: Props) {
    ...
    const handleClose = () => {
        setVisible(false);
        setTimeout(() => { setAdvice(null); setError(null); }, 220);
    };
        ...
        <div style={aiWidgetWrapper}>
            ...
            {error && (
                <div style={errorBox}>
                    ...
                    <button onClick={handleClose} style={errorCloseBtn}>×</button>
                </div>
            )}
            ...
            {advice && (
                <div style={{
                    ...
                    <div style={adviceHeader}>
                        ...
                        <button onClick={handleClose} style={closeBtn} aria-label="閉じる">×</button>
                    </div>
